        	...
        	<div class="midBox">
                ...
                <div class="passportBox">
                	<div class="passportSucBox">
                    	<div class="sucTop tac"><i class="icon icon_suc mr10 vat"></i><span class="dib vat">重置密码成功</span></div>
                        <div class="sucMid tac lh20">您可以用新密码登录玉米平台</div>
                        <div class="sucBom tac lh20"><span>系统将在<span class="j_countDown">5</span>S后返回登录页面，</span> <a href="${ctx}/index">立即登录</a></div>
                    </div>
                </div>
            </div>
        </div>
