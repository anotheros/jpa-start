...
<%@ page import="com.laozapp.util.ConfigUtil"%>
...
<script>
	function ssoLogout(){
		if(confirm('确定要退出系统吗？')){
			...
			top.location.href ='<%=ConfigUtil.INSTANCE.getProperty("casServerLogoutUrl")%>?service=<%=ConfigUtil.INSTANCE.getProperty("casClientServerName")%>';
		}
	}
</script>
